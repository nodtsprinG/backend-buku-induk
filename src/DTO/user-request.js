...
const validateKesehatan = () => [
    ...
    check('kesehatan.tinggi')
        ...
        .notEmpty()
        .withMessage(
            'Tinggi badan dalam kesehatan wajib diisi dan berupa string'
        ),
    check('kesehatan.berat_badan')
        .isString()
        .notEmpty()
        .withMessage(
            'Berat badan dalam kesehatan wajib diisi dan berupa string'
        ),
]
...
const validateTempatTinggal = () => [
    ...
    check('tempat_tinggal.jarak_ke_sekolah')
        ...
        .isString()
        .withMessage(
            'Jarak ke sekolah dalam tempat tinggal harus berupa string'
        ),
]
